...
public:
    ...
    // If display() of derived class is not defined then this fxn will be called otherwise derived class fxn will overrid base class fxn.
    virtual void display()
    {
        cout << "Bogus code" << endl;
    }

    // This is what happens if we don't write virtual keyword
    // void display()
    // {
    //     cout << "Bogus code" << endl;
    // }
